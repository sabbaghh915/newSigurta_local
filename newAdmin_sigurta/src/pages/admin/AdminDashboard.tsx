          ...
          <div className="h-16 flex items-center justify-between gap-3">
            ...
            <div className="flex items-center gap-2">
              <Button
                ...
                className="gap-2 bg-white/90 text-black hover:bg-white border-violet-600"
                disabled={refreshing}
              >
              ...
              <Button
                ...
                className="bg-white/90 text-black hover:bg-white border-violet-600"
              >
                تسجيل الخروج
              </Button>
            </div>
                      ...
                      {loading ? (
                        ...
                        latestPayments.map((p, index) => (
                          <TableRow key={p._id || Math.random()}>
                            <TableCell className="font-bold text-center text-violet-700">{index + 1}</TableCell>
