...
interface ForeignVehicleData {
  ...
  seatsNumber: string; // عدد المقاعد
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const vehiclePayload = {
        ...
        seatsNumber: vehicleData.seatsNumber || undefined,
            ...
            {currentStep === 1 && (
              <div className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  {/* ✅ عدد المقاعد */}
                  <div className="space-y-2">
                    <Label htmlFor="seatsNumber">عدد المقاعد</Label>
                    <Input
                      id="seatsNumber"
                      type="number"
                      min="1"
                ...
                <Card className="bg-red-50 border-red-200">
                  ...
                  <CardContent className="space-y-4">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                      ...
                      <div>
                        <span className="font-medium text-red-700">عدد المقاعد: </span>
